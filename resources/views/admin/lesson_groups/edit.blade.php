        ...
        <div class="container mx-auto px-4 max-w-2xl">
            <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    <div>
                        <h1 class="text-lg font-bold text-gray-900">Edit Group</h1>
                        <p class="text-xs text-gray-500 mt-1">ID: {{ $group->id }}</p>
                    </div>
                ...
                <div class="p-6">
                    <form action="{{ route('admin.groups.update', $group) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="title" id="title" required value="{{ $group->title }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="order" id="order" required value="{{ $group->order }}"
                                   class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2 px-3 border">
                        </div>
